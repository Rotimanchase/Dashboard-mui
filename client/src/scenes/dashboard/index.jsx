...
const Dashboard = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      ...
      <Box 
        mt="20px" display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="160px" gap="20px"
        sx={{
        ...
        <Box
          ...
          >
            ...
            <Typography p="0 0.6rem" fontSize="o.8rem"
            sx={{ color: theme.palette.secondary[100]}}>
              Breakdown of real sales and information via category for revenue made for this year and total sales.
            </Typography>
          </Box>
      </Box>
    </Box>
