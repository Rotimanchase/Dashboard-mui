...
import { Box, Divider, Drawer, IconButton,
     List, ListItem, ListItemButton, ListItemIcon, ListItemText, 
     Typography, useTheme } from '@mui/material'
import { ChevronLeft, ChevronRightOutlined, HomeOutlined,
     ShoppingCartOutlined, Groups2Outlined,
     ReceiptLongOutlined, PublicOutlined,
     PointOfSaleOutlined, TodayOutlined,
        ...
        sx={{width: drawerWidth, "& .MuiDrawer-paper" : {
            ...
            <Box position="absolute" bottom="2rem">
                ...
                <FlexBetween textTransform='none' gap='1rem' m='1.5rem 2rem 0 3rem'>
                    <Box component="img" alt="profile" src={pImage} height="40px" width="40px" 
